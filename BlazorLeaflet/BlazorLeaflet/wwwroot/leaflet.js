...
export function create(map, objectReference) {
    console.log("create");
    window.maps = {};
    window.layers = {};
    ...
    window.maps[map.id] = leafletMap;
    window.layers[map.id] = [];
}


export function addScriptIfNotExists(url) {

    // Check if script exists
    var scripts = document.getElementsByTagName('script');
    var exists = false;
    for (var i = scripts.length; i--;) {
        if (scripts[i].src == url) { exists = true; break; }
    }
...
export function addCssInNotExists(url) {
    // check if css exists
    var scripts = document.getElementsByTagName('link');
    var exists = false;
    for (var i = scripts.length; i--;) {
        if (scripts[i].href == url) { exists = true; break; }
    }
